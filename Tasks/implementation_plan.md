...
## Фаза 4: Рефакторинг и Очистка (СЛЕДУЮЩИЙ ЭТАП)
**Цель**: Устранить технический долг.

| Задача | Статус | Описание |
|---|---|---|
| API Фасады | [ ] | Удалить проверки `shouldUseRealApi` |
| mockApi.ts | [ ] | Удалить файл и папку `services/mock` |
| Валидация | [ ] | Унифицировать Zod на frontend и backend |
| E2E тесты | [ ] | Обновить для работы с реальным Backend |
| Виртуализация | [ ] | Lazy loading для больших списков |
