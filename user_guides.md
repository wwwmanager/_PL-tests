...
2. Выберите транспортное средство из выпадающего списка.
3. Укажите период отчёта (дата начала и дата окончания).
4. Нажмите кнопку «Сформировать отчёт» для построения сводки.
5. Просмотрите данные по пробегу, расходу топлива, количеству рейсов и отклонениям от норм.
6. Экспортируйте отчёт в Excel через кнопку «Экспорт в Excel» для передачи в бухгалтерию.
...
1. Перейдите в раздел «Отчёты» и выберите транспортное средство.
2. Укажите период отчёта и дополнительные фильтры (организация, водитель, статус ПЛ).
3. Нажмите «Сформировать отчёт» для построения детальной сводки.
4. Проверьте корректность данных, включая отклонения от норм расхода.
5. Добавьте комментарии к отчёту при необходимости (доступно для проверяющих и администраторов).
6. Экспортируйте отчёт в Excel или PDF для передачи в бухгалтерию.
